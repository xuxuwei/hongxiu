...
<section class="content">
    ...
    　　
         书名 <input type="text" name="novel.novelname"><br>
         作者 <input type="text" name="novel.writer"><br>
         图片 <input type="file" name="file"><br>
         图书简介<textarea rows="5" name="novel.introduce"></textarea><br>
        图书类型   <select name="novel.type">
		<option value="最新小说" selected="selected">最新小说</option>
		<option value="短篇小说">短篇小说</option>
		<option value="言情小说">言情小说</option>
               </select>  <br> 
       是否vip <input type="radio" name="novel.vip.vip" id="vip" value="是" checked="checked" />是
		    <input type="radio" name="novel.vip.vip" id="vip1" value="否" />否<br>
