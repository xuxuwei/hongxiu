...
<section class="content">
	...
	<form action="fileupload1.action" method="post" enctype="multipart/form-data">
    　　
         书名 <input type="text" name="novel.novelname" value="${novel1.novelname}"><br>
         作者 <input type="text" name="novel.writer" value="${novel1.writer}"><br>
         图片 <input type="file" name="file" value="${novel1.image}"><br>
         图书简介<input type="text" style="size: 300" name="novel.introduce" value="${novel1.introduce}"><br>
        图书类型   <select name="novel.type">
		<option value="最新小说" <c:if test="${novel1.type=='最新小说' }">selected="selected"</c:if>>最新小说</option>
		<option value="短篇小说" <c:if test="${novel1.type=='最新小说' }">selected="selected"</c:if>>短篇小说</option>
		<option value="言情小说" <c:if test="${novel1.type=='最新小说' }">selected="selected"</c:if>>言情小说</option>
               </select>  <br> 
       是否vip <input type="radio" name="novel.vip.vip" id="vip" value="是" <c:if test="${novel1.vip.vip=='是'}">checked="checked"</c:if> />是
		    <input type="radio" name="novel.vip.vip" id="vip1" value="否" <c:if test="${novel1.vip.vip=='否'}">checked="checked"</c:if> />否<br>
