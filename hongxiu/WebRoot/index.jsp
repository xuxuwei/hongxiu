...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		...
		<li><a href="help.jsp"><span class="glyphicon glyphicon-question-sign"></span>帮助</a></li>
		</ul>
		</div>
	</div>
</nav>
	...
	<div class="container">
		<div class="row" style="width: 820px;margin-left:180px">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=1">
						<img src="image/maitian.jpg" alt="">
						<div class="caption">
							小说名麦田里的守望者<br>
							点击量：56<br>
							类型：最新小说<br>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=2">
						<img src="image/weicheng.jpg" alt="">
						<div class="caption">
							小说名：围城<br>
							点击量：200<br>
							类型：短篇小说<br>
				...
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=3">
						<img src="image/window.jpg" alt="">
						<div class="caption">
							小说名：窗边的小豆豆<br>
							点击量：300<br>
							类型：言情小说<br>
				...
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=4">
						<img src="image/nuowei.jpg" alt="">
						<div class="caption">
							小说名：挪威的森林<br>
							点击量：400<br>
							类型：最新小说<br>
				...
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=5">
				...
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=6">
						<img src="image/zhang.jpg" alt="">
						<div class="caption">
							小说名：张爱玲经典散文集<br>
							点击量：600<br>
							类型：最新小说<br>
				...
				<div class="thumbnail">
				    <a href="xiangxi.action?novel.id=">
						<img src="${r.image}" alt="">
						<div class="caption">
							小说名：
							点击量：
