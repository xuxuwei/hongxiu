		...
		<div class="col-md-8">
				<div class="container-fluid" style="padding:0;margin-left:200px">
				    <div class="row info-content">
                        ...
                        <h1 align="center" >《${n.novelname}》<span class="badge">new</span></h1>
						...
						<li id="four"><a href="#extjs">添加时间</a></li>
						</ul>
						<div class="tab-content" ">
							<div class="tab-pane fade in active" id="html5">${n.introduce}</div>
							<div class="tab-pane fade" id="bootstrap">${n.writer} </div>
							<div class="tab-pane fade" id="jquery">${n.type}</div>
							<div class="tab-pane fade" id="extjs">${n.addtime}</div>
						</div>
						<div class="btn-group">
							<div class="btn-group">
							...
							<div class="btn-group">
								<button class="btn btn-default">开始阅读</button>
							</div>
							<div class="btn-group">
...
小说名：《${n.novelname}》
<br><br>
		<table id="myTable" border="0" align="center" cellpadding="0" cellspacing="0" width="1000">
				<thead>
					<tr>
						<th class="avatar">章节</th>
						<th>添加时间</th>
						<th>更新时间</th>
						<th>操作</th>
					</tr>
					...
					<tbody>
						...
						<tr>
							...
							<td>${c.createtime}</td>
							<td>${c.updatetime}</td>
							<td><a href="begin.action?chapter.id=${c.id}">开始阅读</a></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>				 	
