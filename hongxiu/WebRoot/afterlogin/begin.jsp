				...
				<div class="container-fluid" style="padding:0;margin-left:200px">
				    <div class="row info-content">
						...
						<div class="btn-group">
							...
							<div class="btn-group">
								<button class="btn btn-default"><a href="read.action?novel.id=${n.id}">选择章节</a></button>
							</div>
							<div class="btn-group">
...
<br><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="quit.action">退出本小说阅读</a><br><br>
小说名：《${n.novelname}》&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         ${chapter.chaptername}<br><br>
