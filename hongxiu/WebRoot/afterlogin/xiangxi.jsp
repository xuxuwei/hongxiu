...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="quit.action">退出本小说阅读</a>
						 	<h1>留下评论</h1>
				  			<div >
								<form action="remark.action" method="post" name="post_comment">
									<div>
										<label>评论标题<span>*</span></label>
										<input type="text"  style="width: 725px;" name="message.title" value=" "></input>
									</div>
									<div>
										<label>评论内容<span>*</span></label>
										<input type="text"  style="width: 725px;" name="message.words" value=" "></input>
									</div>
									<input type="submit" value="发表评论"  class="btn btn-default" style="margin-left: 700px">
								</form>
								读者评论：<br>
						<ul class="nav nav-tabs" style="margin-top:30px;">
